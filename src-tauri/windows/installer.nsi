; Pinned from tauri-cli-v2.11.4, MIT/Apache-2.0 (see TAURI-LICENSE-MIT).
; Upstream: crates/tauri-bundler/src/bundle/windows/nsis/installer.nsi
; Local change: retain the three legacy registry namespaces below.
; Product/binary/publisher/shortcut names come from current configuration.
Unicode true
...
; Stable installer identity: changing these would create a parallel installation.
